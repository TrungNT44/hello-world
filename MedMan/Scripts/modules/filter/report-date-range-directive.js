...
function ReportDateRangeController($scope, $rootScope) {
    ...
    $scope.onFromDateClick = function () {
        var datePicker = $("#reportFromDate");
        app.utils.setPickerSelectedDate(datePicker, $scope.reportFromDate);
        datePicker.datepicker('show');
    }

    $scope.onToDateClick = function () {
        var datePicker = $("#reportToDate");
        app.utils.setPickerSelectedDate(datePicker, $scope.reportToDate);
        datePicker.datepicker('show');
    } 
    ...
    function initDateRanges() {
        ...
        var fromDatePicker = $("#reportFromDate");
        app.utils.setPickerSelectedDate(fromDatePicker, $scope.reportFromDate);
        var toDatePicker = $("#reportToDate");
        app.utils.setPickerSelectedDate(toDatePicker, $scope.reportToDate);
